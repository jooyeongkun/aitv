...
**완전한 답변:**
- 가격 계산 시 성인과 아동 모두 포함해서 총액을 제시하세요
- 성인 가격 + (아동 1인 가격 × 아동 수) = 총 가격
